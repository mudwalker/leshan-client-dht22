...
/*******************************************************************************
 * Modificado por Pedro Hurtado para el TFM del Master en Big Data y Business Analytics de IFM
 * 2019
 *
 *********************************************************************************/
...
public class LeshanClientDht22 {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanClientDht22.class);
